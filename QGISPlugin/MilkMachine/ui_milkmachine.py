...
class Ui_MilkMachine(object):
    def setupUi(self, MilkMachine):
        ...
        MilkMachine.setTabOrder(self.spinBox_filtering_moving, self.pushButton_filtering_apply)
        MilkMachine.setTabOrder(self.pushButton_filtering_apply, self.checkBox_filtering_showplot)
        MilkMachine.setTabOrder(self.checkBox_filtering_showplot, self.lineEdit_time_active)
